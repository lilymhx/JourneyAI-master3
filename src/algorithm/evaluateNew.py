...
model = keras.models.load_model('./vggtransfer_last.h5', custom_objects={'mylayer': mylayer})
model.load_weights('./vggtransfer_last.h5')
...
datagen_train = datagen_train.flow_from_directory('../../data/train',target_size=(124,124),shuffle=True,batch_size=20)

datagen_test = ImageDataGenerator()
datagen_test = datagen_test.flow_from_directory('../../data/test', target_size=(124, 124), shuffle=False,batch_size=20)
